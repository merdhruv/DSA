...
public class TheSinglyLinkedList {
	...
	// (c) let head be re-assigned to point to the new node
	...
	public void insertBefore(int data, int beforedata) {
		...
		if(temp.data == beforedata) {
			...
			// THE FOLLOWING PIECE OF CODE HAS A SMALL BUG, PLEASE LOCATE AND CORRECT IT
	...
	// Deletion of a node
	// verify if the list is present at the first place
	...
	// re-aligned, and the same will be done even if the node to be deleted is the last node
	public void deleteNode(int key) {   // key is the data of the node which is to be deleted
		...
		// it the node to be deleted is the last node
	...
	public static void main(String[] args) {
		...
		// add the logic to perform the operations on the list
